...
# logs should be written to /opt/eseal/log/eseal.log - not sure but maybe they are even rotated

# https://docs.spring.io/spring-boot/docs/current/reference/html/deployment.html#deployment.installing.nix-services.system-d
cp eseal.service /etc/systemd/system
# maybe should restart systemctl daemon?
