...
class DocumentSignControllerTests {
    ...
    void SignDocumentSuccess() throws Exception {
        ...
        SignDocumentRequestDto.ToSignDocument toSignDocument =  new SignDocumentRequestDto().new ToSignDocument();
    ...
    void SignDocumentInternalError() throws Exception {
        ...
        assertThat(apiError.getApiErrorBody().getCode()).isEqualTo(HttpStatus.INTERNAL_SERVER_ERROR.value());
    ...
    void SignDocumentEmptyOrMissingUsername() throws Exception {
        ...
        MockHttpServletResponse responseEmptyField = this.mockMvc.perform(
                post(this.signingPath)
                        .content(this.objectMapper.writeValueAsBytes(signDocumentRequestDto))
                        .header(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
        ...
        MockHttpServletResponse responseMissingField = this.mockMvc.perform(
                post(this.signingPath)
                        .content(this.objectMapper.writeValueAsBytes(signDocumentRequestDto))
                        .header(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
        ...
        for (MockHttpServletResponse response : errorResponses) {
            ...
            assertThat(apiError.getApiErrorBody()).isNotNull();
            assertThat(apiError.getApiErrorBody().getMessage()).isEqualTo("Field username cannot be empty");
    ...
    void SignDocumentEmptyOrMissingPassword() throws Exception {
        ...
        for (MockHttpServletResponse response : errorResponses) {
            ...
            assertThat(response.getStatus()).isEqualTo(HttpStatus.BAD_REQUEST.value());
            assertThat(apiError.getApiErrorBody()).isNotNull();
            assertThat(apiError.getApiErrorBody().getMessage()).isEqualTo("Field password cannot be empty");
            assertThat(apiError.getApiErrorBody().getCode()).isEqualTo(HttpStatus.BAD_REQUEST.value());
            assertThat(apiError.getApiErrorBody().getStatus()).isEqualTo(HttpStatus.BAD_REQUEST);
        }
    }
    ...
    void SignDocumentEmptyOrMissingBytes() throws Exception {
        ...
        for (MockHttpServletResponse response : errorResponses) {
            ...
            assertThat(response.getStatus()).isEqualTo(HttpStatus.BAD_REQUEST.value());
            assertThat(apiError.getApiErrorBody()).isNotNull();
            assertThat(apiError.getApiErrorBody().getMessage()).isEqualTo("Field toSignDocument.bytes cannot be empty");
            assertThat(apiError.getApiErrorBody().getCode()).isEqualTo(HttpStatus.BAD_REQUEST.value());
            assertThat(apiError.getApiErrorBody().getStatus()).isEqualTo(HttpStatus.BAD_REQUEST);
        }
    }
    ...
    void SignDocumentEmptyOrMissingName() throws Exception {
        ...
        for (MockHttpServletResponse response : errorResponses) {
            ...
            assertThat(response.getStatus()).isEqualTo(HttpStatus.BAD_REQUEST.value());
            assertThat(apiError.getApiErrorBody()).isNotNull();
            assertThat(apiError.getApiErrorBody().getMessage()).isEqualTo("Field toSignDocument.name cannot be empty");
            assertThat(apiError.getApiErrorBody().getCode()).isEqualTo(HttpStatus.BAD_REQUEST.value());
            assertThat(apiError.getApiErrorBody().getStatus()).isEqualTo(HttpStatus.BAD_REQUEST);
        }
    }
    ...
    void SignDocumentMissingToSignDocument() throws Exception {
        ...
        MockHttpServletResponse responseMissingField = this.mockMvc.perform(
            ...
            APIError apiError = this.objectMapper.readValue(responseMissingField.getContentAsString(), APIError.class);
            assertThat(responseMissingField.getStatus()).isEqualTo(HttpStatus.BAD_REQUEST.value());
            assertThat(apiError.getApiErrorBody()).isNotNull();
            assertThat(apiError.getApiErrorBody().getMessage()).isEqualTo("Field toSignDocument cannot be empty");
            assertThat(apiError.getApiErrorBody().getCode()).isEqualTo(HttpStatus.BAD_REQUEST.value());
            assertThat(apiError.getApiErrorBody().getStatus()).isEqualTo(HttpStatus.BAD_REQUEST);
    }
    ...
    void SignDocumentNoContentTypeHeader() throws Exception {
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.BAD_REQUEST.value());
        assertThat(apiError.getApiErrorBody()).isNotNull();
        assertThat(apiError.getApiErrorBody().getMessage()).isEqualTo("Content type 'application/octet-stream' " +
