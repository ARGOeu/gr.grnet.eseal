...
class RemoteProviderHttpEsealClientTests {
    ...
    @InjectMocks
    private RemoteProviderHttpEsealClient remoteProviderHttpEsealClient =  new RemoteProviderHttpEsealClient();
    ...
    void TestDocumentSignSuccessful() throws Exception {
        ...
        CloseableHttpResponse mockResponse = buildMockSuccessfulResponse(documentData, HttpStatus.SC_OK);
    ...
    void TestDocumentSignFailToLogon() throws Exception {
        ...
        CloseableHttpResponse mockResponse = buildMockUnSuccessfulResponse(errMessage, HttpStatus.SC_OK);
    ...
    void TestDocumentSignInvalidExpiredTOTP() throws Exception {
        ...
        UnprocessableEntityException exc =
                Assertions.assertThrows(InvalidTOTPException.class, () ->
                        this.remoteProviderHttpEsealClient.sign("doc", "u", "p", "k")
                );
    ...
    void TestDocumentSignGenericProviderError() throws Exception {
        ...
        CloseableHttpResponse mockResponse = buildMockUnSuccessfulResponse(errMessage, HttpStatus.SC_INTERNAL_SERVER_ERROR);
    ...
    // TODO Revisit this code test to add maybe a better way to test that the retry interval and count are honored
    @Test
    void TestDocumentSignIOExceptionRetryEnabled() throws Exception {
        ...
        // that means that the invocation should take at least 15 seconds to complete when the IO exception occurs
        RemoteProviderProperties remoteProviderProperties =  new RemoteProviderProperties();
    ...
    private CloseableHttpResponse buildMockSuccessfulResponse(String dataField, int httpStatus) throws IOException{
    ...
    private CloseableHttpResponse buildMockUnSuccessfulResponse(String dataField, int httpStatus) throws IOException{
    ...
    private CloseableHttpResponse buildMockClosableHttpResponse(byte[] responseBody, int httpStatus)
        ...
        when(response.getStatusLine()).thenReturn(new BasicStatusLine(HttpVersion.HTTP_1_1, httpStatus,""));
