...
/**
 *
 * DocumentValidatorLOTL is used in the document validation process
 * using the european trusted list as trust source material
 */
...
public class DocumentValidatorLOTL {
    ...
    /**
     * initialize sets up the internal lotl validation job(pulling and loading all the needed trusted material)
     * and the certificate verifier that utilizes the trust sources to perform the document validation
     */
    ...
    /**
     * onlineLOTLRefresh refreshes the content of the lotl trust source by pulling new material from the online
     * lotl url
     */
