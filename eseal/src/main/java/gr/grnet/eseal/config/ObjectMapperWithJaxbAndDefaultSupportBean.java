...
/**
 * Exposes an {@link ObjectMapper} {@link Bean} in order to override Spring's default. The new
 * mapper supports both, {@link JacksonAnnotationIntrospector} as a primary and {@link
 * JaxbAnnotationIntrospector} as a secondary.
 */
@Configuration
