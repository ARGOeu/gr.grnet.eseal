...
/**
 * RemoteHttpEsealClientBean is a {@link Bean} responsible for the exposure of the http client that will
 * take care of signing and timestamping documents, using a remote provider
 */
@Configuration
